...
<body>
    ...
    <div class="d-flex align-items-stretch">
        ...
        <div class="page-content">
            ...
            <section class="no-padding-top no-padding-bottom">
                ...
                <div class="container-fluid">
                    <!-- Espaço reservado p/ renderizar o conteúdo de cada view que estender esse layout -->
    ...
    <!-- Espaço reservado p/ renderizar os scripts de cada view que estender esse layout -->
